...
$stmt = $conn->prepare("SELECT * from galeries LIMIT 15 OFFSET ".$offset);
$stmt->execute();
                ...
                <div class="col-sm-4">
                    <a href="galery.php?id=<?php echo $results[$i]['id'] ?>">
                        <div class="panel panel-default category">
                            <div class="panel-body clear-padding"><img class="img-responsive teste" src="<?php echo $results[$i]['image'] ?>" alt="<?php echo $results[$i]['name'] ?>"></div>
